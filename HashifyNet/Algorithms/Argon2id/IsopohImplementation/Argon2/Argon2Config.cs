...
namespace Isopoh.Cryptography.Argon2
{
	...
	/// </summary>
	internal sealed class Argon2Config
	{
		...
		/// to <see cref="SecureArray"/>.<see cref="SecureArray.SecureArray.DefaultCall"/>.
		/// </summary>
		public SecureArrayCall SecureArrayCall { get; set; } = SecureArray.SecureArray.DefaultCall;
	}
}