...
namespace Isopoh.Cryptography.Argon2
{
	...
	internal sealed partial class Argon2
	{
		...
		/// cref="SecureArray"/>.<see cref="SecureArray.SecureArray.DefaultCall"/>.
		/// </param>
		/// <returns>
		/// The Argon2 hash of the given password.
		/// </returns>
			...
			SecureArrayCall secureArrayCall = null)
		{
			...
			return Hash(
				new Argon2Config
				{
					...
					Type = type,
					SecureArrayCall = secureArrayCall ?? SecureArray.SecureArray.DefaultCall,
				});
		}
		...
		/// </param>
		/// <param name="secureArrayCall">
		/// The methods that get called to secure arrays. A null value defaults to <see cref="SecureArray"/>.<see cref="SecureArray.SecureArray.DefaultCall"/>.
		/// </param>
		/// <returns>
		/// True on success; false otherwise.
		/// </returns>
